...
bool jBlock::cellAvailable (int newX, int newY) {
...
jBlock::jBlock(int level, Cell *bottomLeft,
...
void jBlock::removeCell(Cell *removedCell) {
...
void jBlock::clockwise() {
    ...
    if (orientation == 0) {
        ...
        block[2] = (*board)[bottomLeftY - 1][bottomLeftX + 2];
