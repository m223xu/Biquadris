...
bool lBlock::cellAvailable (int newX, int newY) {
...
lBlock::lBlock(int level, Cell *bottomLeft,
...
void lBlock::removeCell(Cell *removedCell) {
...
void lBlock::clockwise() {
    ...
    if (orientation == 0) {
        ...
        block[2] = (*board)[bottomLeftY - 2][bottomLeftX];
        block[3] = (*board)[bottomLeftY][bottomLeftX + 1];
        for (int i = 0; i < 4; ++i) {
            block[i]->setActive(blockVal);
        }
    }
        ...
        block[0] = (*board)[bottomLeftY - 2][bottomLeftX];
        ...
        block[0] = (*board)[bottomLeftY][bottomLeftX];
        block[1] = (*board)[bottomLeftY][bottomLeftX + 1];
        block[2] = (*board)[bottomLeftY][bottomLeftX + 2];
        block[3] = (*board)[bottomLeftY - 1][bottomLeftX + 2];
        for (int i = 0; i < 4; ++i) {
            block[i]->setActive(blockVal);
        }
